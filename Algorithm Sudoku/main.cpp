...
int main()
{
    ...
    //int** arr = new int* [9]{         //Level 0
    //    new int[9]{ 0,0,8,0,0,7,0,0,0 },
    //    new int[9]{ 0,4,2,0,0,5,0,0,0 },
    //    new int[9]{ 0,0,0,0,0,0,0,0,0 },
    //    new int[9]{ 0,0,3,0,0,6,8,0,1 },
    //    new int[9]{ 0,0,0,0,0,0,0,0,6 },
    //    new int[9]{ 9,0,0,0,0,0,0,0,0 },
    //    new int[9]{ 0,8,0,1,3,0,4,7,0 },
    //    new int[9]{ 0,0,0,0,9,0,0,0,0 },
    //    new int[9]{ 0,1,0,0,0,0,0,0,0 },
    //};

    int** arr = new int* [9]{         //Level 0
        new int[9]{ 0,3,2,0,0,6,1,0,0 },
        new int[9]{ 4,1,0,0,0,0,0,0,0 },
        new int[9]{ 0,0,0,9,0,1,0,0,0 },
        new int[9]{ 5,0,0,0,9,0,0,0,4 },
        new int[9]{ 0,6,0,0,0,0,0,7,0 },
        new int[9]{ 3,0,0,0,2,0,0,0,5 },
        new int[9]{ 0,0,0,5,0,8,0,0,0 },
        new int[9]{ 0,0,0,0,0,0,0,1,9 },
        new int[9]{ 0,0,7,0,0,0,8,6,0 },
    };
