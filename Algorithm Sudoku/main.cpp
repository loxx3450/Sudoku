...
int main()
{
    ...
    int** arr = new int* [9]{         //Level 0
        new int[9]{ 0,0,0,0,0,0,0,0,0 },
        new int[9]{ 2,3,1,0,9,0,0,0,0 },
        new int[9]{ 0,6,5,0,0,3,1,0,0 },
        new int[9]{ 0,0,8,9,2,4,0,0,0 },
        new int[9]{ 1,0,0,0,5,0,0,0,6 },
        new int[9]{ 0,0,0,1,3,6,7,0,0 },
        new int[9]{ 0,0,9,3,0,0,5,7,0 },
        new int[9]{ 0,0,0,0,1,0,8,4,3 },
        new int[9]{ 0,0,0,0,0,0,0,0,0 },
    };
