...
//};
     ...
     int** arr = new int* [9]{         //level 4
            new int[9]{ 0,5,0,7,6,0,0,0,9 },
            new int[9]{ 0,2,6,0,0,0,0,0,0 },
            new int[9]{ 0,0,7,9,0,0,5,0,0 },
            new int[9]{ 0,1,0,0,0,2,0,0,0 },
            new int[9]{ 6,0,0,0,0,1,0,0,7 },
            new int[9]{ 8,7,0,5,0,0,0,0,3 },
            new int[9]{ 0,0,1,3,0,0,0,4,0 },
            new int[9]{ 4,0,0,0,5,0,8,0,0 },
            new int[9]{ 7,0,0,0,0,0,0,0,6 },
    };
