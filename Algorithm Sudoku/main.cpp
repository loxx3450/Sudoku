...
int main()
{
    ...
    int** arr = new int* [9]{         //Level 0
        new int[9]{ 0,0,0,5,0,0,0,0,0 },
        new int[9]{ 4,2,5,0,9,0,0,0,1 },
        new int[9]{ 8,0,0,0,1,0,0,2,0 },
        new int[9]{ 5,0,0,0,0,0,0,0,0 },
        new int[9]{ 0,1,9,0,0,0,4,6,0 },
        new int[9]{ 0,0,0,0,0,0,0,0,2 },
        new int[9]{ 0,9,0,0,4,0,0,0,3 },
        new int[9]{ 2,0,0,0,6,0,8,0,7 },
        new int[9]{ 0,0,0,0,0,1,6,0,0 },
    };
