...
int** arr = new int* [9]{         //Level 4
            new int[9]{ 0,0,0,4,0,0,0,0,8 },
            new int[9]{ 0,0,0,0,0,5,3,0,0 },
            new int[9]{ 0,0,0,0,0,0,1,9,0 },
            new int[9]{ 0,0,0,0,9,0,0,3,4 },
            new int[9]{ 0,7,0,1,0,2,0,8,0 },
            new int[9]{ 5,0,8,0,0,0,0,0,0 },
            new int[9]{ 0,4,0,0,7,1,0,2,0 },
            new int[9]{ 7,0,6,0,0,0,0,0,0 },
            new int[9]{ 8,9,0,0,0,0,0,0,0 },
};
