...
//};
     ...
     int** arr = new int* [9]{         //level 4
            new int[9]{ 1,3,0,4,0,0,0,0,0 },
            new int[9]{ 0,0,0,5,0,8,0,1,0 },
            new int[9]{ 5,0,0,0,0,0,7,3,4 },
            new int[9]{ 0,0,0,0,0,0,0,0,0 },
            new int[9]{ 0,1,0,6,0,7,0,0,0 },
            new int[9]{ 4,0,0,0,0,0,5,0,8 },
            new int[9]{ 0,0,6,8,9,0,0,0,0 },
            new int[9]{ 3,0,0,0,2,0,0,0,0 },
            new int[9]{ 0,7,1,0,0,5,9,0,6 },
    };
