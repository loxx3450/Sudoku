...
bool NakedFoursome::findPossibleFoursomeInField(Field* temp)
{
...
bool NakedFoursome::findPossibleFoursomeInRow(Cell* row, int size)
{
	Cell* arrayCells = new Cell[size]{};
...
bool NakedFoursome::nakedFoursomeInField(Map* map, Field* temp, int temp_i, int temp_j)
{
...
bool NakedFoursome::nakedFoursomeInRow(Cell* row)
{
	int count{};
