...
bool ExtendedNakedGroup::ifPassRulesForNakedTriplets(Cell* array, int size)
{
...
int ExtendedNakedGroup::fillArraysForString(Cell* row, Cell* arrayCells, int* arrayIndexes, int max_size)
{
	int index{};
...
int ExtendedNakedGroup::fillArraysForField(Field* temp, Cell* arrayCells, Point* arrayPoints, int max_size)
{
	int index{};
...
bool ExtendedNakedGroup::isNewIndex(int* array, int size, int index)
{
	for (int i{}; i < size; ++i)
	{
		if (index == array[i])
...
bool ExtendedNakedGroup::isNewPoint(Point* array, int size, int x, int y)
{
	for (int i{}; i < size; ++i)
	{
...
bool ExtendedNakedGroup::editNotesInRow(Cell* row, Cell* array, int* arr, int size)
{
	bool flag{ false };
...
bool ExtendedNakedGroup::editNotesInField(Field* tempField, Cell* array, Point* arr, int size)
{
	bool flag{ false };
